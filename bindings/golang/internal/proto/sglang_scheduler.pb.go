...
type GenerateRequest struct {
	...
	ReturnRoutedExperts bool `protobuf:"varint,18,opt,name=return_routed_experts,json=returnRoutedExperts,proto3" json:"return_routed_experts,omitempty"`
	// Absolute start position for returned routed experts
	RoutedExpertsStartLen int32 `protobuf:"varint,19,opt,name=routed_experts_start_len,json=routedExpertsStartLen,proto3" json:"routed_experts_start_len,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *GenerateRequest) GetReturnRoutedExperts() bool {
	if x != nil {
		return x.ReturnRoutedExperts
	}
	return false
}

func (x *GenerateRequest) GetRoutedExpertsStartLen() int32 {
	if x != nil {
		return x.RoutedExpertsStartLen
	}
	return 0
}
...
const file_sglang_scheduler_proto_rawDesc = "" +
	...
	"\x0ebootstrap_room\x18\x03 \x01(\x05R\rbootstrapRoom\"\xc5\a\n" +
	...
	"\x06stream\x18\x11 \x01(\bR\x06stream\x122\n" +
	"\x15return_routed_experts\x18\x12 \x01(\bR\x13returnRoutedExperts\x127\n" +
	"\x18routed_experts_start_len\x18\x13 \x01(\x05R\x15routedExpertsStartLen\"R\n" +
