...
pub struct ChatCompletionRequest {
    ...
    /// Stop regex pattern(s)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub stop_regex: Option<StringOrArray>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub bootstrap_host: Option<Value>,

    #[serde(skip_serializing_if = "Option::is_none")]
    pub bootstrap_port: Option<Value>,

    #[serde(skip_serializing_if = "Option::is_none")]
    pub bootstrap_room: Option<Value>,
